            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-4">
                    ...
                    <div className="flex items-center space-x-2">
                        <div className="w-20 h-15 sm:w-25 sm:h-10 lg:w-27 lg:h-17 bg-gradient-to-br flex items-center justify-center">
                            <img
                        ...
                        <div>
                            <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">StudyBuddy</h1>
                        </div>
                    </div>
